...
1. **Ложные срабатывания**  
   Картина/афиша и рюкзак принимаются за человека (формы, контрастные контуры).  
   <br>
   <img src="assets/issue_false_poster.jpg" alt="Ложное: картина/постер" width="45%">
   <img src="assets/issue_false_backpack.jpg" alt="Ложное: рюкзак" width="45%">

2. **Мелкие люди на заднем плане**  
   Далёкие, быстро движущиеся люди не детектируются или “слипаются” из-за NMS.  
   <br>
   <img src="assets/issue_small_far.jpg" alt="Проблема: мелкие дальние люди" width="45%">
